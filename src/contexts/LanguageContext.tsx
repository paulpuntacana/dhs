...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'contact.cta.description': 'Join 20+ businesses already growing with our AI-powered cold outreach and sales guidance system.',
    'contact.cta.subtitle': 'No long-term contracts required',
    'contact.faq.title': 'Frequently Asked Questions',
    'contact.faq.subtitle': 'Get answers to common questions about our AI-powered lead generation services.',
  ...
  nl: {
    ...
    'contact.faq.subtitle': 'Krijg antwoord op veelgestelde vragen over onze AI-gedreven leadgeneratie diensten.',
    ...
    'terms.article13.title': 'Artikel 13: Liability',
    'terms.article13.content': 'De aansprakelijkheid van de opdrachtnemer is beperkt tot het factuurbedrag, met een maximum van €300,000 per event.',
    'terms.article14.title': 'Artikel 14: Termination',
    ...
    'terms.article15.title': 'Artikel 15: Suspension and Dissolution',
    'terms.article15.content': 'De opdrachtnemer kan de overeenkomst opschorten of ontbinden bij wanbetaling of contractbreuk.',
    'terms.article16.title': 'Artikel 16: Limitation Periods',
    'terms.article16.content': 'Allle vorderingen tegen de opdrachtnemer dienen binnen één jaar na ontdekking te worden ingediend.',
    'terms.article17.title': 'Artikel 17: Electronic Communication',
    'terms.article17.content': 'Electronic communication is deemed equivalent to written communication.',
    'terms.article18.title': 'Artikel 18: Final Provisions',
    'terms.article18.content': 'These terms and conditions are governed by Dutch law. Disputes will be resolved by competent Dutch courts.',
    ...
    'privacy.article1.title': 'Article 1: Personal Data We Process',
    'privacy.article1.intro': 'DHS processeert persoonsgegevens die u zelf aan ons verstrekt, bijvoorbeeld wanneer u contact met ons opneemt of gebruik maakt van onze diensten. Deze gegevens kunnen omvatten:',
    'privacy.article1.item1': 'Name and contact details (email address, phone number);',
    'privacy.article1.item2': 'Company information;',
    'privacy.article1.item3': 'Login credentials for our services;',
    'privacy.article1.item4': 'Payment information (such as bank account, invoice details).',
    ...
    'privacy.article1.additional1': 'IP address and device information;',
    'privacy.article1.additional2': 'Browsing and click behavior (ook via cookies);',
    'privacy.article1.additional3': 'Data verkregen uit openbare bronnen zoals LinkedIn.',
    'privacy.article1.conclusion': 'DHS verwerkt alleen gegevens die noodzakelijk zijn voor de hieronder beschreven doeleinden.',
    
    'privacy.article2.title': 'Article 2: Legal Basis for Processing',
    'privacy.article2.intro': 'We verwerken persoonsgegevens op basis van:',
    ...
    'privacy.article3.title': 'Article 3: Purposes of Processing',
    'privacy.article3.intro': 'We verwerken persoonsgegevens voor:',
    ...
    'privacy.article4.title': 'Article 4: Retention Periods',
    'privacy.article4.intro': 'We bewaren persoonsgegevens niet langer dan noodzakelijk. Voorbeelden van bewaartermijnen:',
    ...
    'privacy.article5.item3': 'Met verwerkers die diensten voor ons verlenen (zoals hosting of email tools), met wie verwerkersovereenkomsten zijn gesloten.',
    
    'privacy.article6.title': 'Article 6: Cookies and Analytics',
    'privacy.article6.intro': 'We gebruiken functionele en analytische cookies voor:',
    'privacy.article6.item1': 'Goed functioneren van de website;',
    'privacy.article6.item2': 'Verbeteringsmaatregelen voor de gebruikerservaring en analyse van gedrag op de site;',
  ...
  de: {
    ...
    'contact.faq.subtitle': 'Erhalten Sie Antworten auf häufige Fragen zu unseren KI-gestützten Lead-Generierungsdiensten.',
  ...
  es: {
    ...
    'contact.faq.subtitle': 'Obtén respuestas a preguntas comunes sobre nuestros servicios de generación de leads impulsados por IA.',
