...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'footer.tagline': 'Transforming B2B lead generation with AI-powered solutions',
    'footer.legal': 'Legal',
    ...
    'terms.lastUpdated': 'Last Updated: March 2024',
    'terms.intro': 'These Terms and Conditions govern your use of Den Hartogh Solutions\' services. By using our services, you agree to these terms.',
    'terms.definitions': 'Definitions',
    'terms.definitions.content': '"Service" refers to the AI-powered lead generation services provided by Den Hartogh Solutions. "Client" refers to any individual or entity using our services.',
    'terms.services': 'Services',
    'terms.services.content': 'We provide AI-powered lead generation services, including prospect identification, contact information gathering, and lead qualification. The specific services will be detailed in your service agreement.',
    'terms.obligations': 'Client Obligations',
    'terms.obligations.content': 'Clients must provide accurate information and comply with all applicable laws and regulations. Clients are responsible for the use of any leads provided.',
    'terms.payment': 'Payment Terms',
    'terms.payment.content': 'Payment terms will be specified in your service agreement. All fees are exclusive of VAT unless otherwise stated.',
    'terms.confidentiality': 'Confidentiality',
    'terms.confidentiality.content': 'Both parties agree to maintain the confidentiality of any proprietary information shared during the course of the service.',
    'terms.liability': 'Liability',
    'terms.liability.content': 'Our liability is limited to the amount paid for the services in the month in which the claim arose.',
    'terms.termination': 'Termination',
    'terms.termination.content': 'Either party may terminate the agreement with 30 days written notice. We reserve the right to terminate immediately for breach of these terms.',
    'terms.changes': 'Changes to Terms',
    'terms.changes.content': 'We may modify these terms at any time. Continued use of our services after changes constitutes acceptance of the new terms.',
    'terms.contact': 'Contact',
    'terms.contact.content': 'For questions about these terms, please contact us at info@denhartogh.solutions.',

    // Terms & Conditions - Dutch
    'terms.title.nl': 'Algemene Voorwaarden',
    'terms.lastUpdated.nl': 'Laatst bijgewerkt: Maart 2024',
    'terms.intro.nl': 'Deze Algemene Voorwaarden regelen uw gebruik van de diensten van Den Hartogh Solutions. Door gebruik te maken van onze diensten gaat u akkoord met deze voorwaarden.',
    'terms.definitions.nl': 'Definities',
    'terms.definitions.content.nl': '"Dienst" verwijst naar de AI-gestuurde leadgeneratie diensten van Den Hartogh Solutions. "Klant" verwijst naar elk individu of bedrijf dat gebruik maakt van onze diensten.',
    'terms.services.nl': 'Diensten',
    'terms.services.content.nl': 'Wij bieden AI-gestuurde leadgeneratie diensten, inclusief prospectidentificatie, contactinformatie verzameling en leadkwalificatie. De specifieke diensten worden beschreven in uw serviceovereenkomst.',
    'terms.obligations.nl': 'Verplichtingen van de Klant',
    'terms.obligations.content.nl': 'Klanten moeten accurate informatie verstrekken en voldoen aan alle toepasselijke wetten en regels. Klanten zijn verantwoordelijk voor het gebruik van de verstrekte leads.',
    'terms.payment.nl': 'Betalingsvoorwaarden',
    'terms.payment.content.nl': 'Betalingsvoorwaarden worden gespecificeerd in uw serviceovereenkomst. Alle kosten zijn exclusief BTW tenzij anders vermeld.',
    'terms.confidentiality.nl': 'Vertrouwelijkheid',
    'terms.confidentiality.content.nl': 'Beide partijen komen overeen de vertrouwelijkheid te handhaven van alle gedeelde bedrijfsinformatie tijdens de dienstverlening.',
    'terms.liability.nl': 'Aansprakelijkheid',
    'terms.liability.content.nl': 'Onze aansprakelijkheid is beperkt tot het bedrag betaald voor de diensten in de maand waarin de claim ontstond.',
    'terms.termination.nl': 'Beëindiging',
    'terms.termination.content.nl': 'Elke partij kan de overeenkomst beëindigen met 30 dagen schriftelijke opzegging. Wij behouden ons het recht voor om direct te beëindigen bij schending van deze voorwaarden.',
    'terms.changes.nl': 'Wijzigingen in Voorwaarden',
    'terms.changes.content.nl': 'Wij kunnen deze voorwaarden te allen tijde wijzigen. Voortgezet gebruik van onze diensten na wijzigingen betekent acceptatie van de nieuwe voorwaarden.',
    'terms.contact.nl': 'Contact',
    'terms.contact.content.nl': 'Voor vragen over deze voorwaarden kunt u contact opnemen via info@denhartogh.solutions.',

    // Terms & Conditions - German
    'terms.title.de': 'Allgemeine Geschäftsbedingungen',
    'terms.lastUpdated.de': 'Zuletzt aktualisiert: März 2024',
    'terms.intro.de': 'Diese Allgemeinen Geschäftsbedingungen regeln Ihre Nutzung der Dienste von Den Hartogh Solutions. Durch die Nutzung unserer Dienste stimmen Sie diesen Bedingungen zu.',
    'terms.definitions.de': 'Definitionen',
    'terms.definitions.content.de': '"Dienst" bezieht sich auf die KI-gestützten Lead-Generierungsdienste von Den Hartogh Solutions. "Kunde" bezieht sich auf jede Person oder Organisation, die unsere Dienste nutzt.',
    'terms.services.de': 'Dienste',
    'terms.services.content.de': 'Wir bieten KI-gestützte Lead-Generierungsdienste, einschließlich Prospect-Identifikation, Kontaktinformationssammlung und Lead-Qualifizierung. Die spezifischen Dienste werden in Ihrer Servicevereinbarung detailliert beschrieben.',
    'terms.obligations.de': 'Kundenpflichten',
    'terms.obligations.content.de': 'Kunden müssen genaue Informationen bereitstellen und alle geltenden Gesetze und Vorschriften einhalten. Kunden sind für die Nutzung der bereitgestellten Leads verantwortlich.',
    'terms.payment.de': 'Zahlungsbedingungen',
    'terms.payment.content.de': 'Zahlungsbedingungen werden in Ihrer Servicevereinbarung spezifiziert. Alle Gebühren sind zzgl. MwSt., sofern nicht anders angegeben.',
    'terms.confidentiality.de': 'Vertraulichkeit',
    'terms.confidentiality.content.de': 'Beide Parteien vereinbaren, die Vertraulichkeit aller während der Dienstleistung geteilten proprietären Informationen zu wahren.',
    'terms.liability.de': 'Haftung',
    'terms.liability.content.de': 'Unsere Haftung ist auf den Betrag begrenzt, der für die Dienste im Monat der Entstehung des Anspruchs gezahlt wurde.',
    'terms.termination.de': 'Kündigung',
    'terms.termination.content.de': 'Jede Partei kann die Vereinbarung mit 30 Tagen schriftlicher Kündigungsfrist beenden. Wir behalten uns das Recht vor, bei Verstoß gegen diese Bedingungen sofort zu kündigen.',
    'terms.changes.de': 'Änderungen der Bedingungen',
    'terms.changes.content.de': 'Wir können diese Bedingungen jederzeit ändern. Die weitere Nutzung unserer Dienste nach Änderungen bedeutet die Annahme der neuen Bedingungen.',
    'terms.contact.de': 'Kontakt',
    'terms.contact.content.de': 'Bei Fragen zu diesen Bedingungen kontaktieren Sie uns bitte unter info@denhartogh.solutions.',

    // Terms & Conditions - Spanish
    'terms.title.es': 'Términos y Condiciones',
    'terms.lastUpdated.es': 'Última actualización: Marzo 2024',
    'terms.intro.es': 'Estos Términos y Condiciones rigen su uso de los servicios de Den Hartogh Solutions. Al utilizar nuestros servicios, acepta estos términos.',
    'terms.definitions.es': 'Definiciones',
    'terms.definitions.content.es': '"Servicio" se refiere a los servicios de generación de leads impulsados por IA de Den Hartogh Solutions. "Cliente" se refiere a cualquier individuo o entidad que utilice nuestros servicios.',
    'terms.services.es': 'Servicios',
    'terms.services.content.es': 'Proporcionamos servicios de generación de leads impulsados por IA, incluyendo identificación de prospectos, recopilación de información de contacto y calificación de leads. Los servicios específicos se detallarán en su acuerdo de servicio.',
    'terms.obligations.es': 'Obligaciones del Cliente',
    'terms.obligations.content.es': 'Los clientes deben proporcionar información precisa y cumplir con todas las leyes y regulaciones aplicables. Los clientes son responsables del uso de los leads proporcionados.',
    'terms.payment.es': 'Términos de Pago',
    'terms.payment.content.es': 'Los términos de pago se especificarán en su acuerdo de servicio. Todos los honorarios son excluyendo IVA a menos que se indique lo contrario.',
    'terms.confidentiality.es': 'Confidencialidad',
    'terms.confidentiality.content.es': 'Ambas partes acuerdan mantener la confidencialidad de cualquier información propietaria compartida durante el curso del servicio.',
    'terms.liability.es': 'Responsabilidad',
    'terms.liability.content.es': 'Nuestra responsabilidad está limitada al monto pagado por los servicios en el mes en que surgió el reclamo.',
    'terms.termination.es': 'Terminación',
    'terms.termination.content.es': 'Cualquiera de las partes puede terminar el acuerdo con 30 días de aviso por escrito. Nos reservamos el derecho de terminar inmediatamente por incumplimiento de estos términos.',
    'terms.changes.es': 'Cambios en los Términos',
    'terms.changes.content.es': 'Podemos modificar estos términos en cualquier momento. El uso continuado de nuestros servicios después de los cambios constituye la aceptación de los nuevos términos.',
    'terms.contact.es': 'Contacto',
    'terms.contact.content.es': 'Para preguntas sobre estos términos, contáctenos en info@denhartogh.solutions.',

    // Terms & Conditions - German
    'terms.article7.de': 'Artikel 7: Lieferung und Annahme',
    'terms.article7.content.de': 'Die Lieferung erfolgt, wenn die Arbeit dem Kunden zur Verfügung gestellt wird. Die Annahme gilt als erfolgt, wenn innerhalb von 14 Tagen keine Beanstandungen vorliegen.',
    'terms.article8.de': 'Artikel 8: Eigentumsvorbehalt und geistiges Eigentum',
    'terms.article8.content.de': 'Alle Rechte an geistigem Eigentum an den Arbeiten verbleiben beim Auftragnehmer, sofern nicht ausdrücklich übertragen.',
    'terms.article9.de': 'Artikel 9: Höhere Gewalt',
    'terms.article9.content.de': 'Der Auftragnehmer haftet nicht für Verzögerungen oder Ausfälle aufgrund von Umständen außerhalb seiner Kontrolle.',

    // Terms & Conditions - Spanish
    'terms.article7.es': 'Artículo 7: Entrega y Aceptación',
    'terms.article7.content.es': 'La entrega tiene lugar cuando el trabajo se pone a disposición del cliente. Se considera que la aceptación ha ocurrido si no se presentan quejas dentro de 14 días.',
    'terms.article8.es': 'Artículo 8: Propiedad Intelectual',
    'terms.article8.content.es': 'Todos los derechos de propiedad intelectual sobre los trabajos permanecen con el proveedor, a menos que se transfieran expresamente.',
    'terms.article9.es': 'Artículo 9: Fuerza Mayor',
    'terms.article9.content.es': 'El proveedor no será responsable por retrasos o fallos debido a circunstancias fuera de su control.',
  },
  nl: {
    // Navigation
    'nav.home': 'Home',
    ...
    'careers.whyJoin.innovation.description': 'Werk met cutting-edge AI technology and shape the future of B2B sales automation.',
    'careers.whyJoin.growth.title': 'Personal Growth',
    'careers.whyJoin.growth.description': 'Develop your skills in a dynamic environment with opportunities for learning and advancement.',
    'careers.whyJoin.impact.title': 'Real Impact',
    'careers.whyJoin.impact.description': 'Help businesses transform their sales processes and achieve measurable growth.',
    ...
    'terms.article8.title': 'Artikel 8: Retention of Title and Intellectual Property',
    'terms.article8.content': 'All intellectual property rights to the work remain with the contractor unless explicitly transferred.',
    'terms.article9.title': 'Artikel 9: Force Majeure',
    'terms.article9.content': 'The contractor is not liable for delays or failures due to circumstances beyond its control.',
    'terms.article10.title': 'Artikel 10: Fees and Costs',
    'terms.article10.content': 'All prices are exclusive of VAT and other government levies unless stated otherwise.',
    'terms.article11.title': 'Artikel 11: Payment',
    'terms.article11.content': 'Payment must be made within 14 days of the invoice date. Late payment incurs interest charges.',
    'terms.article12.title': 'Artikel 12: Delivery Times',
    'terms.article12.content': 'Stated delivery times are approximate and not binding unless explicitly agreed otherwise.',
    ...
    'privacy.article2.title': 'Artikel 2: Legal Basis for Processing',
    'privacy.article2.intro': 'We process personal data based on:',
    'privacy.article2.item1': 'Performance of a contract;',
    'privacy.article2.item2': 'Legal obligations;',
    'privacy.article2.item3': 'Legitimate interest (such as marketing and service improvement);',
    ...
    'privacy.article3.title': 'Artikel 3: Purposes of Processing',
    'privacy.article3.intro': 'We process personal data for:',
    'privacy.article3.item1': 'Performance of contracts and service delivery;',
    'privacy.article3.item2': 'Customer service and communication;',
    'privacy.article3.item3': 'Analysis and improvement of our services;',
    ...
    'privacy.article4.title': 'Artikel 4: Retention Periods',
    'privacy.article4.intro': 'We do not retain personal data longer than necessary. Examples of retention periods:',
    'privacy.article4.item1': 'Contact requests: maximum 2 years;',
    'privacy.article4.item2': 'Newsletter subscription: until you unsubscribe;',
    'privacy.article4.item3': 'Customer data: maximum 7 years (for administrative obligations).',
    
    'privacy.article5.title': 'Artikel 5: Sharing with Third Parties',
    'privacy.article5.intro': 'DHS only shares personal data with third parties:',
    'privacy.article5.item1': 'When necessary for the performance of our services;',
    'privacy.article5.item2': 'When we are legally required to do so;',
    'privacy.article5.item3': 'With processors who provide services on our behalf (such as hosting or email tools), with whom processing agreements have been concluded.',
    
    'privacy.article6.title': 'Artikel 6: Cookies and Analytics',
    'privacy.article6.intro': 'We use functional and analytical cookies for:',
    'privacy.article6.item1': 'Proper functioning of the website;',
    'privacy.article6.item2': 'Improving user experience and analyzing behavior on the site;',
    'privacy.article6.item3': 'Marketing purposes (only if consent has been given).',
    
    'privacy.article7.title': 'Artikel 7: Social Media and Communication',
    'privacy.article7.content': 'When contacting via social media (such as LinkedIn or WhatsApp), DHS may gain access to profile information. This privacy policy applies to the data we obtain from this. For the use of social media itself, the policy of the respective platform applies.',
    
    'privacy.article8.title': 'Artikel 8: Newsletter',
    'privacy.article8.content': 'You will only receive our newsletter if you have signed up for it or are a customer. Each newsletter contains an option to unsubscribe.',
    
    'privacy.article9.title': 'Artikel 9: Rights of Data Subjects',
    'privacy.article9.intro': 'You have the right to:',
    'privacy.article9.item1': 'Access, correction or deletion of your personal data;',
    'privacy.article9.item2': 'Withdrawal of consent;',
    'privacy.article9.item3': 'Object to processing;',
    ...
    'privacy.article10.title': 'Artikel 10: Security',
    'privacy.article10.intro': 'DHS takes appropriate technical and organizational measures to secure personal data:',
    'privacy.article10.item1': 'Use of SSL certificates;',
    'privacy.article10.item2': 'Access control and encryption;',
    'privacy.article10.item3': 'Devices with security software and updates;',
    ...
    'privacy.article11.title': 'Artikel 11: Liability',
    'privacy.article11.content': 'The information on our website has been compiled with care, but DHS accepts no liability for incompleteness or inaccuracies. Use of our website is at your own risk.',
    
    'privacy.article12.title': 'Artikel 12: Contact Information',
    'privacy.article12.content': 'For questions about this privacy policy, you can contact us via: Email: info@denhartogh.solutions',
    
    'privacy.article13.title': 'Artikel 13: Changes',
    'privacy.article13.content': 'DHS reserves the right to modify this privacy policy. We recommend checking this statement regularly. The current version was updated on June 12, 2025.',
    footer: {
  ...
  de: {
    ...
    'contact.faq.strategy.q1.answer': 'Cold E-Mail bietet Skalierbarkeit und Personalisierung. Sie erreichen veel prospects mit einer gerichteten Botschaft, zonder ihren Arbeitsablauf zu unterbrechen. In vergleichsweise mit LinkedIn ist E-Mail oft direkter und gestructurerter. LinkedIn kann jedoch ein kräftig ergänzender Kanal sein.',
    'contact.faq.strategy.q2.question': 'Wie passt Cold E-Mail in eine breitere Marketingstrategie?',
    'contact.faq.strategy.q2.answer': 'Cold Outreach ist ein effektives Element einer breiteren Strategie. Es ermöglicht Ihnen, neue Märkte zu erkunden und prospects persönlich anzusprechen, was zu höherem Engagement und Konversionen führt.',
    ...
    'terms.article8.title': 'Artículo 8: Eigentumsvoorbehoud und geistiges Eigentum',
    ...
    'privacy.article1.additional2': 'Comportamiento de navegación y clics (u.a. a través de cookies);',
    ...
    'privacy.article4.item2': 'Suscríption al boletín: hasta que se dé de baja;',
    ...
    'privacy.article7.content': 'Al contactar a través de redes sociales (como LinkedIn o WhatsApp) puede DHS obtener acceso a información del perfil. Esta política de privacidad se aplica a los datos que obtenemos de esto. Para el uso de las redes sociales en sí, se aplica la política de la plataforma respectiva.',
  ...
  es: {
    ...
    'terms.article10.title': 'Artículo 10: Gebühren und Kosten',
    ...
    'terms.article11.title': 'Artículo 11: Zahlung',
    ...
    'terms.article12.title': 'Artículo 12: Lieferzeiten',
    ...
    'terms.article13.title': 'Artículo 13: Haftung',
    ...
    'terms.article14.title': 'Artículo 14: Kündigung',
    ...
    'terms.article15.title': 'Artículo 15: Aussetzung und Auflösung',
    ...
    'terms.article16.title': 'Artículo 16: Verjährungsfristen',
    ...
    'terms.article17.title': 'Artículo 17: Elektronische Kommunikation',
    'terms.article17.content': 'Elektronische Kommunikation gilt als gleichwertig mit schriftlicher Kommunikation.',
    'terms.article18.title': 'Artículo 18: Schlussbestimmungen',
