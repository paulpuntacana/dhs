...
const translations: Record<string, Record<string, string>> = {
  ...
  nl: {
    ...
    'careers.status.description': 'We hebben op dit moment geen openstaande vacatures, maar we zijn altijd geïnteresseerd in contact met getalenteerde professionals die onze visie delen.',
    ...
    'careers.whyJoin.growth.description': 'Ontwikkel je vaardigheden in een dynamische omgeving met mogelijkheden voor leren en doorgroei.',
    'careers.whyJoin.impact.title': 'Echte Impact',
    'careers.whyJoin.impact.description': 'Help bedrijven hun salesprocessen te transformeren en meetbare groei te realiseren.',
    'careers.openApplication.title': 'Geïnteresseerd in Werken bij Ons?',
    'careers.openApplication.description': 'Stuur ons een open sollicitatie en vertel ons hoe jij kunt bijdragen aan onze missie.',
    'careers.openApplication.include.title': 'Voeg toe:',
    ...
    'careers.openApplication.button': 'Verstuur Open Sollicitatie',

    // Terms Page
    'terms.title': 'Algemene Voorwaarden',
    'terms.subtitle': 'Algemene Voorwaarden voor Den Hartogh Solutions',
    'terms.article1.title': 'Artikel 1: Begripsbepalingen',
    'terms.article1.intro': 'In deze algemene voorwaarden hebben de volgende begrippen de volgende betekenissen:',
    'terms.article1.a': 'Bescheiden: alle overeenkomsten, offertes en andere documenten betreffende de opdracht;',
    'terms.article1.b': 'Medewerker: iedere persoon die werkzaam is voor of namens opdrachtnemer;',
    ...
    'terms.article1.d': 'Opdrachtgever: de partij die opdrachtnemer opdracht geeft tot het verrichten van werkzaamheden;',
    'terms.article1.e': 'Opdrachtnemer: Den Hartogh Solutions, ingeschreven bij de Kamer van Koophandel onder nummer 93891237;',
    'terms.article1.f': 'Werkzaamheden: alle activiteiten die opdrachtnemer voor opdrachtgever verricht.',
    'terms.article2.title': 'Artikel 2: Toepasselijkheid',
    'terms.article2.content': 'Deze algemene voorwaarden zijn van toepassing op alle offertes, overeenkomsten en leveringen van opdrachtnemer, tenzij uitdrukkelijk schriftelijk anders overeengekomen.',
    'terms.article3.title': 'Artikel 3: Offertes en totstandkoming overeenkomsten',
    'terms.article3.content': 'Alle offertes zijn vrijblijvend, tenzij anders vermeld. Overeenkomsten zijn pas bindend na schriftelijke bevestiging door opdrachtnemer.',
    'terms.article4.title': 'Artikel 4: Verplichtingen opdrachtgever',
    'terms.article4.content': 'Opdrachtgever dient alle benodigde informatie en medewerking te verstrekken voor een goede uitvoering van de werkzaamheden.',
    'terms.article5.title': 'Artikel 5: Uitvoering werkzaamheden',
    'terms.article5.content': 'Opdrachtnemer zal de werkzaamheden met zorgvuldigheid en conform de stand van de techniek uitvoeren.',
    ...
    'terms.article7.content': 'Oplevering vindt plaats wanneer de werkzaamheden ter beschikking worden gesteld aan opdrachtgever. Acceptatie wordt geacht te hebben plaatsgevonden indien binnen 14 dagen geen klachten worden ingediend.',
    'terms.article8.title': 'Artikel 8: Eigendomsvoorbehoud en intellectueel eigendom',
    'terms.article8.content': 'Alle intellectuele eigendomsrechten op de werkzaamheden blijven bij opdrachtnemer, tenzij uitdrukkelijk overgedragen.',
    'terms.article9.title': 'Artikel 9: Overmacht',
    'terms.article9.content': 'Opdrachtnemer is niet aansprakelijk voor vertragingen of tekortkomingen door omstandigheden buiten zijn controle.',
    'terms.article10.title': 'Artikel 10: Honoraria en kosten',
    'terms.article10.content': 'Alle prijzen zijn exclusief BTW en andere heffingen van overheidswege, tenzij anders vermeld.',
    ...
    'terms.article13.content': 'De aansprakelijkheid van opdrachtnemer is beperkt tot het factuurbedrag, met een maximum van €300.000 per gebeurtenis.',
    ...
    'terms.article15.content': 'Opdrachtnemer kan de overeenkomst opschorten of ontbinden bij wanbetaling of contractbreuk.',
    'terms.article16.title': 'Artikel 16: Verjaringstermijnen',
    'terms.article16.content': 'Alle vorderingen jegens opdrachtnemer dienen binnen één jaar na ontdekking te worden ingediend.',
    ...
    'terms.article18.content': 'Deze voorwaarden worden beheerst door Nederlands recht. Geschillen worden beslecht door bevoegde Nederlandse rechters.',
    ...
    'privacy.description': 'Privacyverklaring voor Den Hartogh Solutions - Hoe wij omgaan met uw persoonsgegevens',
    'privacy.intro': 'Den Hartogh Solutions ("wij", "ons") is verantwoordelijk voor de verwerking van persoonsgegevens zoals weergegeven in deze privacyverklaring. DHS hecht grote waarde aan de bescherming van persoonsgegevens en verwerkt jouw gegevens dan ook met uiterste zorgvuldigheid. In deze verklaring informeren wij je over hoe wij omgaan met persoonsgegevens.',
    
    'privacy.article1.title': 'Artikel 1: Persoonsgegevens die worden verwerkt',
    'privacy.article1.intro': 'DHS verwerkt persoonsgegevens die je zelf aan ons verstrekt, bijvoorbeeld wanneer je contact met ons opneemt of gebruikmaakt van onze diensten. Deze gegevens kunnen onder andere zijn:',
    'privacy.article1.item1': 'Naam en contactgegevens (e-mailadres, telefoonnummer);',
    'privacy.article1.item2': 'Bedrijfsgegevens;',
    'privacy.article1.item3': 'Inloggegevens voor onze diensten;',
    'privacy.article1.item4': 'Betaalgegevens (zoals bankrekening, factuurgegevens).',
    'privacy.article1.additional': 'Daarnaast verwerken wij gegevens over jouw gebruik van onze diensten:',
    'privacy.article1.additional1': 'IP-adres en apparaatgegevens;',
    'privacy.article1.additional2': 'Surf- en klikgedrag (o.a. via cookies);',
    'privacy.article1.additional3': 'Gegevens verkregen via openbare bronnen zoals LinkedIn.',
    'privacy.article1.conclusion': 'DHS verwerkt alleen gegevens die noodzakelijk zijn voor de hieronder beschreven doelen.',
    
    'privacy.article2.title': 'Artikel 2: Rechtsgronden van de verwerking',
    ...
    'privacy.article2.item3': 'Gerechtvaardigd belang (zoals marketing en verbetering van diensten);',
    'privacy.article2.item4': 'Toestemming (indien vereist).',
    
    'privacy.article3.title': 'Artikel 3: Doeleinden van de verwerking',
    ...
    'privacy.article3.item4': 'Marketingdoeleinden (alleen met toestemming of bij gerechtvaardigd belang);',
    'privacy.article3.item5': 'Voldoen aan wettelijke verplichtingen.',
    ...
    'privacy.article4.item2': 'Nieuwsbriefinschrijving: totdat je je uitschrijft;',
    ...
    'privacy.article5.item1': 'Als dit nodig is voor uitvoering van onze diensten;',
    'privacy.article5.item2': 'Als wij wettelijk verplicht zijn;',
    'privacy.article5.item3': 'Met verwerkers die namens ons diensten leveren (zoals hosting of e-mailtools), met wie verwerkersovereenkomsten zijn gesloten.',
    ...
    'privacy.article6.item1': 'Correct functioneren van de website;',
    ...
    'privacy.article7.content': 'Bij contact via social media (zoals LinkedIn of WhatsApp) kan DHS toegang krijgen tot profielinformatie. Deze privacyverklaring is van toepassing op de gegevens die wij daaruit verkrijgen. Voor het gebruik van social media zelf geldt het beleid van het betreffende platform.',
    
    'privacy.article8.title': 'Artikel 8: Nieuwsbrief',
    'privacy.article8.content': 'Je ontvangt alleen onze nieuwsbrief als je je hiervoor hebt aangemeld of klant bent. Elke nieuwsbrief bevat een mogelijkheid tot afmelden.',
    
    'privacy.article9.title': 'Artikel 9: Rechten van betrokkenen',
    'privacy.article9.intro': 'Je hebt recht op:',
    'privacy.article9.item1': 'Inzage, correctie of verwijdering van je persoonsgegevens;',
    'privacy.article9.item2': 'Intrekking van toestemming;',
    'privacy.article9.item3': 'Bezwaar tegen verwerking;',
    'privacy.article9.item4': 'Gegevensoverdraagbaarheid.',
    'privacy.article9.contact': 'Verzoeken kun je sturen naar: info@denhartogh.solutions. Je hebt ook het recht om een klacht in te dienen bij de Autoriteit Persoonsgegevens.',
    ...
    'privacy.article10.item2': 'Toegangscontrole en versleuteling;',
    'privacy.article10.item3': 'Apparaten met beveiligingssoftware en updates;',
    'privacy.article10.item4': 'Vertrouwelijkheidsverplichting voor betrokken medewerkers.',
    
    'privacy.article11.title': 'Artikel 11: Aansprakelijkheid',
    'privacy.article11.content': 'De informatie op onze website is met zorg samengesteld, maar aanvaardt DHS geen aansprakelijkheid voor onvolledigheden of onjuistheden. Gebruik van onze website is op eigen risico.',
    
    'privacy.article12.title': 'Artikel 12: Contactgegevens',
    'privacy.article12.content': 'Voor vragen over dit privacybeleid kun je contact opnemen via: E-mail: info@denhartogh.solutions',
    
    'privacy.article13.title': 'Artikel 13: Wijzigingen',
    'privacy.article13.content': 'DHS behoudt zich het recht voor om deze privacyverklaring aan te passen. Wij raden aan om deze verklaring regelmatig te bekijken. De huidige versie is bijgewerkt op 12 juni 2025.',
  },
  de: {
    // Navigation
    'nav.home': 'Startseite',
    ...
    'careers.whyJoin.impact.description': 'Helfen Sie Unternehmen dabei, ihre Vertriebsprozesse zu transformieren und messbares Wachstum zu erzielen.',
    ...
    'terms.subtitle': 'Allgemeine Geschäftsbedingungen für Den Hartogh Solutions',
    'terms.article1.title': 'Artikel 1: Definitionen',
    'terms.article1.intro': 'In diesen allgemeinen Geschäftsbedingungen haben die folgenden Begriffe die folgenden Bedeutungen:',
    'terms.article1.a': 'Dokumente: alle Vereinbarungen, Angebote und anderen Dokumente im Zusammenhang mit dem Auftrag;',
    ...
    'terms.article1.f': 'Arbeiten: alle Tätigkeiten, die der Auftragnehmer für den Auftraggeber durchführt.',
    ...
    'terms.article3.title': 'Artikel 3: Angebote und Vertragsabschluss',
    'terms.article3.content': 'Alle Angebote sind unverbindlich, sofern nicht anders angegeben. Vereinbarungen sind erst nach schriftlicher Bestätigung durch den Auftragnehmer bindend.',
    'terms.article4.title': 'Artikel 4: Pflichten des Auftraggebers',
    'terms.article4.content': 'Der Auftraggeber muss alle notwendigen Informationen und Mitarbeit für die ordnungsgemäße Ausführung der Arbeiten bereitstellen.',
    'terms.article5.title': 'Artikel 5: Ausführung der Arbeiten',
    'terms.article5.content': 'Der Auftragnehmer wird die Arbeiten mit gebotener Sorgfalt und entsprechend dem Stand der Technik durchführen.',
    'terms.article6.title': 'Artikel 6: Änderungen und Zusatzarbeiten',
    'terms.article6.content': 'Änderungen an den vereinbarten Arbeiten werden nur nach schriftlicher Vereinbarung ausgeführt und können zu Preisanpassungen führen.',
    'terms.article7.title': 'Artikel 7: Lieferung und Abnahme',
    'terms.article7.content': 'Die Lieferung erfolgt, wenn die Arbeiten dem Auftraggeber zur Verfügung gestellt werden. Die Abnahme gilt als erfolgt, wenn innerhalb von 14 Tagen keine Beanstandungen vorgebracht werden.',
    'terms.article8.title': 'Artikel 8: Eigentumsvorbehalt und geistiges Eigentum',
    'terms.article8.content': 'Alle Rechte an geistigem Eigentum an den Arbeiten verbleiben beim Auftragnehmer, sofern nicht ausdrücklich übertragen.',
    ...
    'terms.article10.title': 'Artikel 10: Gebühren und Kosten',
    ...
    'terms.article11.content': 'Die Zahlung muss innerhalb von 14 Tagen nach Rechnungsdatum erfolgen. Verspätete Zahlung führt zu Zinsen.',
    ...
    'terms.article14.title': 'Artikel 14: Kündigung',
    'terms.article14.content': 'Beide Parteien können die Vereinbarung mit angemessener Frist kündigen, vorbehaltlich einer Entschädigung für bereits geleistete Arbeiten.',
    'terms.article15.title': 'Artikel 15: Aussetzung und Auflösung',
    'terms.article15.content': 'Der Auftragnehmer kann die Vereinbarung bei Nichtzahlung oder Vertragsbruch aussetzen oder auflösen.',
    ...
    'terms.article17.content': 'Elektronische Kommunikation gilt als gleichwertig mit schriftlicher Kommunikation.',
    'terms.article18.title': 'Artikel 18: Schlussbestimmungen',
    'terms.article18.content': 'Diese Geschäftsbedingungen unterliegen niederländischem Recht. Streitigkeiten werden von zuständigen niederländischen Gerichten entschieden.',

    // Approach Page CTA
    'approach.cta.title': 'Bereit, Ihre Lead-Generierungs-Herausforderungen zu lösen?',
    'approach.cta.subtitle': 'Gerne zeigen wir Ihnen, wie unsere bewährten Lösungen Ihre konkreten Herausforderungen lösen und dabei messbare Resultate erzielen.',
    ...
    'privacy.description': 'Datenschutzerklärung für Den Hartogh Solutions - Wie wir mit Ihren personenbezogenen Daten umgehen',
    'privacy.intro': 'Den Hartogh Solutions ("wir", "uns") ist verantwortlich für die Verarbeitung personenbezogener Daten, wie in dieser Datenschutzerklärung beschrieben. DHS legt großen Wert auf den Schutz personenbezogener Daten und verarbeitet Ihre Daten mit äußerster Sorgfalt. In dieser Erklärung informieren wir Sie darüber, wie wir mit personenbezogenen Daten umgehen.',
    
    'privacy.article1.title': 'Artikel 1: Personenbezogene Daten, die wir verarbeiten',
    'privacy.article1.intro': 'DHS verarbeitet personenbezogene Daten, die Sie uns selbst zur Verfügung stellen, zum Beispiel wenn Sie uns kontaktieren oder unsere Dienste nutzen. Diese Daten können unter anderem sein:',
    'privacy.article1.item1': 'Name und Kontaktdaten (E-Mail-Adresse, Telefonnummer);',
    'privacy.article1.item2': 'Unternehmensdaten;',
    'privacy.article1.item3': 'Anmeldedaten für unsere Dienste;',
    'privacy.article1.item4': 'Zahlungsdaten (wie Bankkonto, Rechnungsdaten).',
    'privacy.article1.additional': 'Darüber hinaus verarbeiten wir Daten über Ihre Nutzung unserer Dienste:',
    'privacy.article1.additional1': 'IP-Adresse und Gerätedaten;',
    'privacy.article1.additional2': 'Surf- und Klickverhalten (u.a. über Cookies);',
    ...
    'privacy.article2.title': 'Artikel 2: Rechtsgrundlagen der Verarbeitung',
    'privacy.article2.intro': 'Wir verarbeiten personenbezogene Daten auf Basis von:',
    'privacy.article2.item1': 'Erfüllung eines Vertrags;',
    'privacy.article2.item2': 'Gesetzliche Verpflichtungen;',
    'privacy.article2.item3': 'Berechtigtes Interesse (wie Marketing und Verbesserung der Dienste);',
    ...
    'privacy.article3.item4': 'Marketingzwecke (nur mit Einwilligung oder bei berechtigtem Interesse);',
    'privacy.article3.item5': 'Erfüllung gesetzlicher Verpflichtungen.',
    
    'privacy.article4.title': 'Artikel 4: Aufbewahrungsfristen',
    'privacy.article4.intro': 'Wir bewahren personenbezogene Daten nicht länger als notwendig auf. Beispiele für Aufbewahrungsfristen:',
    'privacy.article4.item1': 'Kontaktanfragen: maximal 2 Jahre;',
    'privacy.article4.item2': 'Newsletter-Anmeldung: bis Sie sich abmelden;',
    ...
    'privacy.article5.item3': 'Mit Auftragsverarbeitern, die Dienste in unserem Namen erbringen (wie Hosting oder E-Mail-Tools), mit denen Auftragsverarbeitungsverträge geschlossen wurden.',
    ...
    'privacy.article7.content': 'Bei Kontakt über Social Media (wie LinkedIn oder WhatsApp) kann DHS Zugang zu Profilinformationen erhalten. Diese Datenschutzerklärung gilt für die Daten, die wir daraus erhalten. Für die Nutzung von Social Media selbst gilt die Richtlinie der jeweiligen Plattform.',
    ...
    'privacy.article9.title': 'Artikel 9: Rechte der Betroffenen',
    'privacy.article9.intro': 'Sie haben das Recht auf:',
    'privacy.article9.item1': 'Einsicht, Berichtigung oder Löschung Ihrer personenbezogenen Daten;',
    ...
    'privacy.article9.contact': 'Anfragen können Sie senden an: info@denhartogh.solutions. Sie haben auch das Recht, eine Beschwerde bei der Datenschutzbehörde einzureichen.',
    
    'privacy.article10.title': 'Artikel 10: Sicherheit',
    'privacy.article10.intro': 'DHS trifft angemessene technische und organisatorische Maßnahmen zur Sicherung personenbezogener Daten:',
    ...
    'privacy.article11.content': 'Die Informationen auf unserer Website wurden sorgfältig zusammengestellt, aber DHS übernimmt keine Haftung für Unvollständigkeiten oder Ungenauigkeiten. Die Nutzung unserer Website erfolgt auf eigenes Risiko.',
    
    'privacy.article12.title': 'Artikel 12: Kontaktdaten',
    'privacy.article12.content': 'Für Fragen zu dieser Datenschutzrichtlinie können Sie uns kontaktieren über: E-Mail: info@denhartogh.solutions',
  ...
  es: {
    ...
    'terms.subtitle': 'Términos y Condiciones Generales para Den Hartogh Solutions',
    'terms.article1.title': 'Artículo 1: Definiciones',
    'terms.article1.intro': 'En estos términos y condiciones generales, los siguientes términos tienen los siguientes significados:',
    'terms.article1.a': 'Documentos: todos los acuerdos, ofertas y otros documentos relacionados con la asignación;',
    'terms.article1.b': 'Empleado: cualquier persona que trabaje para o en nombre del contratista;',
    'terms.article1.c': 'Asignación: el acuerdo entre cliente y contratista con respecto a la realización del trabajo;',
    'terms.article1.d': 'Cliente: la parte que encarga al contratista realizar el trabajo;',
    'terms.article1.e': 'Contratista: Den Hartogh Solutions, registrado en la Cámara de Comercio bajo el número 93891237;',
    'terms.article1.f': 'Trabajo: todas las actividades realizadas por el contratista para el cliente.',
    'terms.article2.title': 'Artículo 2: Aplicabilidad',
    'terms.article2.content': 'Estos términos y condiciones generales se aplican a todas las ofertas, acuerdos y entregas del contratista, a menos que se acuerde explícitamente lo contrario por escrito.',
    ...
    'terms.article4.content': 'El cliente debe proporcionar toda la información y cooperación necesarias para la ejecución adecuada del trabajo.',
    'terms.article5.title': 'Artículo 5: Ejecución del Trabajo',
    'terms.article5.content': 'El contratista realizará el trabajo con el debido cuidado y de acuerdo con el estado del arte.',
    'terms.article6.title': 'Artículo 6: Cambios y Trabajo Adicional',
    'terms.article6.content': 'Los cambios al trabajo acordado solo se ejecutarán después del acuerdo escrito y pueden resultar en ajustes de precio.',
    'terms.article7.title': 'Artículo 7: Entrega y Aceptación',
    'terms.article7.content': 'La entrega tiene lugar cuando el trabajo se pone a disposición del cliente. Se considera que la aceptación ha ocurrido si no se presentan quejas dentro de 14 días.',
    'terms.article8.title': 'Artículo 8: Retención de Título y Propiedad Intelectual',
    'terms.article8.content': 'Todos los derechos de propiedad intelectual del trabajo permanecen con el contratista a menos que se transfieran explícitamente.',
    ...
    'terms.article12.content': 'Los tiempos de entrega indicados son aproximados y no vinculantes a menos que se acuerde explícitamente lo contrario.',
    ...
    'terms.article14.content': 'Ambas partes pueden terminar el acuerdo con aviso razonable, sujeto a compensación por el trabajo ya realizado.',
    'terms.article15.title': 'Artículo 15: Suspensión y Disolución',
    'terms.article15.content': 'El contratista puede suspender o disolver el acuerdo en caso de falta de pago o incumplimiento del contrato.',
    ...
    'privacy.description': 'Política de Privacidad para Den Hartogh Solutions - Cómo manejamos sus datos personales',
    ...
    'privacy.article1.item1': 'Nombre y datos de contacto (dirección de email, número de teléfono);',
    'privacy.article1.item2': 'Datos de la empresa;',
    'privacy.article1.item3': 'Credenciales de acceso para nuestros servicios;',
    'privacy.article1.item4': 'Datos de pago (como cuenta bancaria, datos de facturación).',
    'privacy.article1.additional': 'Además, procesamos datos sobre su uso de nuestros servicios:',
    'privacy.article1.additional1': 'Dirección IP y datos del dispositivo;',
    'privacy.article1.additional2': 'Comportamiento de navegación y clics (incluso a través de cookies);',
    ...
    'privacy.article2.item1': 'Ejecución de un contrato;',
    'privacy.article2.item2': 'Obligaciones legales;',
    'privacy.article2.item3': 'Interés legítimo (como marketing y mejora de servicios);',
    ...
    'privacy.article3.item1': 'Ejecución de contratos y prestación de servicios;',
    ...
    'privacy.article5.item1': 'Cuando sea necesario para la ejecución de nuestros servicios;',
    'privacy.article5.item2': 'Cuando estemos legalmente obligados a hacerlo;',
    'privacy.article5.item3': 'Con procesadores que proporcionan servicios en nuestro nombre (como hosting o herramientas de email), con quienes se han celebrado acuerdos de procesamiento.',
    ...
    'privacy.article9.item3': 'Objeción al procesamiento;',
    ...
    'privacy.article11.content': 'La información en nuestro sitio web ha sido compilada con cuidado, pero DHS no acepta responsabilidad por incompletitudes o inexactitudes. El uso de nuestro sitio web es bajo su propio riesgo.',
    
    'privacy.article12.title': 'Artículo 12: Información de Contacto',
    'privacy.article12.content': 'Para preguntas sobre esta política de privacidad, puede contactarnos a través de: Email: info@denhartogh.solutions',
